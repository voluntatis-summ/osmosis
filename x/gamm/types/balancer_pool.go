...
func (pa BalancerPool) GetPoolParams() PoolParams {
...
func (pa *BalancerPool) setInitialPoolParams(params PoolParams, sortedAssets []PoolAsset, curBlockTime time.Time) error {
...
// PoolTypeName returns the name of the pool type.
func (pa BalancerPool) PoolTypeName() string {
	return "Balancer"
}
